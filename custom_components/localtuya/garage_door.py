"""Platform to locally control Tuya-based garage door cover devices."""
import asyncio
import logging
import time
...
class LocaltuyaGarageDoor(LocalTuyaEntity, CoverEntity):
    ...
    def __init__(self, device, config_entry, switchid, **kwargs):
        ...
        self._state_dp_id = 3 # False=closed, True=open
...
#        return False
    ...
    def status_updated(self):
        ...
        self._state = self._open_cmd if self.dps(self._state_dp_id) else self._close_cmd
...
async_setup_entry = partial(async_setup_entry, DOMAIN, LocaltuyaGarageDoor, flow_schema)
